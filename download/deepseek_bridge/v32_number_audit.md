# V22/V15 numeric consistency audit (Zenodo-archive round: archival DOIs wired into both availability statements; v31 ledger retargeted to journal_manuscript_v22.tex + companion_categorical_v15.tex)

**372 PASS / 0 FAIL of 372 checks.**
...
| JP-2 | DAM retarget: numeric square-bracket citations (natbib numbers mode);  | PASS | all present | v3 preamble/backmatter |
| JP-3 | DAM retarget: abstract 150-249 words (Discover Applied Mathematics: 'a | PASS | abstract 245w, keywords 6 | v3 front matter |
| JP-4 | backmatter: Data/Software/Code Availability, Funding, Competing Intere | PASS | all present | v3 backmatter |
| JP-5 | BMB-style references: 29 entries, alphabetical with natbib author-year | PASS | 29 entries, labels True, all keys resolve True | v3 refs (verbatim v2) |
...
| KEIO-11 | companion quotes fractions 0.498 and 0.853 (battery) | PASS | 0.498 count: 3, 0.853 count: 3 | companion_categorical_v15.tex:prop:poincare-averaging + |
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b2779': (np.float64(0.81), np.float64(0.0)), 'b2926': (np.float64(0. | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
...
| O2-15 | prop:keio-o2-limited + rem:keio-o2-invariance in companion; abstract p | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v15.tex (abstract + Keio section) |
...
| N-17 | prop:keio-n-source + rem:keio-n-invariance in companion; abstract carr | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v15.tex (abstract + Keio section) |
...
| R8-ABS-five-axes | abstract: 'robust across six axes: carbon, oxygen, nitrogen, phosphate | PASS | True | companion_categorical_v15.tex abstract |
| R8-ABS-wordcount | abstract under the 250-word Discover Applied Mathematics cap | PASS | 248 words | companion_categorical_v15.tex abstract |
| R8-TEX-fourth-axis proposition | anchor prop:keio-phosphate present | PASS | True | companion_categorical_v15.tex |
| R8-TEX-four-axis remark | anchor rem:keio-p-invariance present | PASS | True | companion_categorical_v15.tex |
| R8-TEX-canonical-selection subsection | anchor sec:canonical-selection present | PASS | True | companion_categorical_v15.tex |
| R8-TEX-homogenized table | anchor tab:canonical-selection present | PASS | True | companion_categorical_v15.tex |
| R8-TEX-selection-rule remark | anchor rem:canonical-protocol present | PASS | True | companion_categorical_v15.tex |
...
| R9-TEX-anchors | prop:keio-iron + rem:keio-iron-invariance present, exactly once | PASS | prop x1, rem x1 | companion_categorical_v15.tex |
| R9-TEX-table-rows | iron x5 + arginine x2 rows present in tab:canonical-selection; restore | PASS | iron01 x1, iron005 x2, iron0025 x2, arg x2 | companion_categorical_v15.tex |
| R9-TEX-escapes | no double-escaped commands remain (patch-F rendering defect fixed: bio | PASS | \\emph x0, \\S\\ref x0 | companion_categorical_v15.tex |
...
| S-13 | patch H present: prop:keio-atpm, rem:keio-multiaxis, ATPM table rows,  | PASS | all present: True | companion_categorical_v15.tex |
| S-14 | six-axis abstract word count < 250 (DAM cap) | PASS | words: 248 | companion_categorical_v15.tex abstract |
...
| P-10 | engine bracket [+0.475,+0.943] and path-dependence wording present; 'c | PASS | bracket present: True | companion_categorical_v15.tex |
...
| P-14 | patch I present: five amendments, no regressions ('45--202', '1,129',  | PASS | edits present: True | companion_categorical_v15.tex |
...
| P-29 | patch J present: tie-break paragraph, closure clauses, feature count f | PASS | edits present: True | companion_categorical_v15.tex |
...
| V17-I1 | top quartile = 110 of the 424 nonzero-kappa genes | PASS | 110.0 | v17 json regulon.expected back-solve (crp) |
| V17-I2-crp | crp 56/89 fold 2.43 q 8.6e-16 | PASS | (56, 89, 2.43, 'q=8.64e-16') | v17 json regulon.crp |
| V17-I2-cra | cra 39/52 fold 2.89 q 2.8e-14 | PASS | (39, 52, 2.89, 'q=2.77e-14') | v17 json regulon.cra |
| V17-I2-fur | fur 24/27 fold 3.43 q 1.5e-11 | PASS | (24, 27, 3.43, 'q=1.55e-11') | v17 json regulon.fur |
| V17-I2-fnr | fnr 46/77 fold 2.3 q 1.5e-11 | PASS | (46, 77, 2.3, 'q=1.55e-11') | v17 json regulon.fnr |
| V17-I2-rpoS | rpoS 26/33 fold 3.04 q 2.7e-10 | PASS | (26, 33, 3.04, 'q=2.73e-10') | v17 json regulon.rpoS |
| V17-I2-fis | fis 22/31 fold 2.74 q 2.9e-07 | PASS | (22, 31, 2.74, 'q=2.9e-07') | v17 json regulon.fis |
| V17-I2-arcA | arcA 41/89 fold 1.78 q 1.1e-05 | PASS | (41, 89, 1.78, 'q=1.14e-05') | v17 json regulon.arcA |
| V17-I2-narL | narL 14/20 fold 2.7 q 0.00011 | PASS | (14, 20, 2.7, 'q=0.000112') | v17 json regulon.narL |
| V17-I2-ihf | ihf 21/38 fold 2.13 q 0.00018 | PASS | (21, 38, 2.13, 'q=0.000177') | v17 json regulon.ihf |
| V17-I2-rpoD | rpoD 86/274 fold 1.21 q 0.00097 | PASS | (86, 274, 1.21, 'q=0.000972') | v17 json regulon.rpoD |
| V17-I2-nagC | nagC 6/8 fold 2.89 q 0.013 | PASS | (6, 8, 2.89, 'q=0.0134') | v17 json regulon.nagC |
| V17-I3 | eleven regulons survive BH q < 0.10 | PASS | 11 | v17 json regulon top_regulons |
| V17-I4 | CRP activation split: median kappa 0.64 vs 0.02, MWU p = 0.0016; repre | PASS | (0.64, 0.02, 0.0016, 0.43) | v17 json regulon.effect_split[0:2] |
| V17-I5 | operons nuo 13/13 (q 4.3e-07), atp 9/9, sdh-suc 8/8, cyo 4/4, manXYZ/p | PASS | 7 operon rows | v17 json operon.top_operons |
| V17-I6 | seven operons BH q < 0.10; 31 testable; 31 regulons, 18 iModulons test | PASS | (7, 31, 31, 18) | v17 json operon + regulon + imodulon |
| V17-I7 | intra-operon gap 0.044 vs inter 1.045 (381 pairs, perm p < 2e-4) | PASS | (0.044, 1.045, 381, 0.0) | v17 json operon gaps |
| V17-I8 | GPR control: 205 disjoint-reaction pairs gap 0.082; 176 shared-reactio | PASS | (205, 0.082, 176) | v17 json operon.gpr_control |
| V17-I9 | iModulons DhaR/Mlc 5/5, ArcA-1 9/13, Crp-2 6/7, ArcA-2 4/5 (carbon/ene | PASS | 4 module rows | v17 json imodulon.top |
| V17-I10 | growth-silent partition: kappa_c nonzero 0/433 on all three paths; val | PASS | 3 paths, ratios (1.45e-3, 2.4e-4, 5.5e-4) | v17 json growth_silent_partition |
| V17-I11 | 237 TRN regulators, 5 with metabolite effectors (FMN, L-tryptophan, ad | PASS | (237, 5, ['FMN', 'L-tryptophan', 'adenosylcobalamin', 'molybdopterin', | v17 json trn_metabolite_effectors |
| V17-II1 | order asymmetry q90 = 101.3 l1 vs WT total flux 770 (~13%) | PASS | (101.3, 770.0, 13.2) | v17 json II chi_q90 + WT_L1 |
| V17-II2 | order rule: rho = 0.442 (p = 2.0e-4), sign 59/66 (binomial p = 2.4e-11 | PASS | (0.442, 'p=0.00021', 59, 'binom=2.4e-11', 66) | v17 json II.order_rule |
| V17-II3 | honest null: chi vs J_dR rho = 0.07 (p = 0.38) | PASS | (0.07, 0.38) | v17 json II spearman_chi_vs_JdR |
| V17-III1 | protein r = -0.083 (n 366), R2 = 0.007 (at most 0.7% of variance); tra | PASS | (-0.083, 0.0069, 0.42, 365) | v17 json III e27_recomputed + protein_layer_r2 |
| V17-III2 | kappa_mu locked metric: protein r = -0.098 (p 0.06), transcript r = +0 | PASS | (-0.098, 0.339) | v17 json III e27 kappa_mu arms |
| V17-IV1 | 50 reactions (1.8% of the network) carry 85.9% of curvature mass | PASS | (0.859, 0.0184) | v17 json IV top_mass_branch_concentration |
| V17-IV2 | 23 of the 25 heaviest reactions participate in all eleven sweeps | PASS | 23 | v17 json IV top25 sweep_participation |
| V17-IV3 | heaviest reactions: PGI 3.7%, ATPS4rpp 3.5%, PFK/FBA 3.3% each, PPP en | PASS | (0.037, 0.035, 0.033, 0.032) | v17 json IV top25_reactions |
| V17-IV4 | top-20 branch metabolites carry 59.7% of mass | PASS | 0.597 | v17 json IV top20 sum |
| V17-IV5 | wall-coordinate table shares (f6p 8.1, g3p 6.9, g6p 5.5, dhap 4.9, pep | PASS | 10 table rows | v17 json IV top20_branch_metabolites |
| V17-IV6 | currency-inclusive: 98.6% of mass on branch/currency-adjacent reaction | PASS | (0.986, 0.858) | v17 json IV including_currency_d6 |
| V17-IV7 | reaction-level: 46.3% of reactions branch-adjacent carry 60.9% of mass | PASS | (0.463, 0.609, 0.0174, 0.5) | v17 json IV primary + sensitivity |
| V17-IV8 | of the fifty heaviest reactions, 56% branch-adjacent vs 46.3% baseline | PASS | (0.56, 0.463) | v17 json IV top_mass_branch_concentration |
| V17-V1 | class shares: exchange 12.4% of reactions / 3.9% of mass / 92.6% flat; | PASS | 3 classes | v17 json V class_stats |
| V17-V2 | per-family internal mass share: nutrient 74.1%, knockdown 75.7% | PASS | (0.741, 0.757) | v17 json V per_family_class_shares |
| V17-V3 | subsystems: gly 23.4%, PPP 19.7%, TCA 13.9%, OXPHOS 11.6%, anaplerosis | PASS | 0.733 | v17 json V top10_subsystems |
| V17-V4 | branch-adjacent reactions carry 74.4% of the internal mass | PASS | 0.744 | v17 json V internal_flatness |
| V17-V5 | iJO glucose one-chamber: D2 total 6.5e-9, zero interior crossings; sup | PASS | ('6.5e-09', 0, 421, 440, 438) | v17 json V ijo_glucose_one_chamber + ijo_active_support |
| V17-EX1 | worked example: 16/16 machine checks pass (phases, jumps, coupling, ka | PASS | 16 PASS / 0 FAIL | v17_worked_example_verification.json |
| V17-EX2 | worked example specifics: kappa(g1) = 1, kappa(g2) = 2; a=b wall silen | PASS | D/E checks | v17_worked_example_verification.json |
| V17-FM1 | abstract <= 249 audit-style words (DAM cap; v20 carries it at 245) wit | PASS | 245 words | journal_manuscript_v22.tex abstract |
| V17-FM2 | refs: 29 entries with kacser1973 + heinrich1974 added; both cited in t | PASS | 29 entries | journal_manuscript_v22_dam_refs.tex |
| V18-FM1 | CRediT authorship contribution statement (retained from the JTB round; | PASS | CRediT roles | journal_manuscript_v22.tex backmatter |
| V18-FM2 | keywords: 6 terms (BMB 4-6); 'path dependence' (the JTB-only 7th term) | PASS | 6 terms | journal_manuscript_v22.tex keywords |
| V19-FM3 | structural restructure: categorical subsection out, corollary retained | PASS | 5 sub-gates | journal_manuscript_v22.tex structure |
| V19-FM4 | plain title retained; v20 narrows it to the measured claim ('predicts  | PASS | title gates | journal_manuscript_v22.tex front matter |
| V19-FM5 | intro claim structure rebuilt: five-finding enumeration gone, three qu | PASS | intro gates | journal_manuscript_v22.tex intro (vs the v18 claim list |
| V20-1 | F3: direct trajectory rank correlation reported (rho = +0.92 P1 / +0.9 | PASS | artifact 0.9176 / 0.9551 (n 424) | v20_path_rank_stability.json + journal_manuscript_v22.t |
| V20-2 | F4: intro Glivenko--Cantelli sentence carries the two-regime qualifier | PASS | qualifier present: True | journal_manuscript_v22.tex intro |
| V20-3 | F5: 'rank identity' -> 'rank agreement'; 'metric invariance holds' ->  | PASS | old forms absent: True | journal_manuscript_v22.tex |
| V20-4 | F6: translation-buffering mechanism hedged at both remaining flat site | PASS | abstract hedge: True | journal_manuscript_v22.tex abstract + intro |
| V20-5 | DAM formatting: numeric square-bracket citations in both manuscripts;  | PASS | natbib/caption gates | journal_manuscript_v22.tex + companion_categorical_v15. |
| V20-6 | F2: companion six-axis sentence covers all three body categories -- th | PASS | qualifier present: True | companion_categorical_v15.tex abstract |
| V20-7 | companion keywords: 6 terms (Springer 4-6 range); 2-category / informa | PASS | 6 terms | companion_categorical_v15.tex keywords |
| V20-8 | cross-citation titles aligned: the main cites the companion's actual t | PASS | both aligned | journal_manuscript_v22_dam_refs.tex + companion_refs_v1 |
| V20-9 | Reproducibility text: the stated audit-suite size equals the v32 ledge | PASS | stated == $372$ | journal_manuscript_v22.tex Reproducibility + this audit |
| V20-10 | v20 refs list: 29 entries preserved (kacser1973 + heinrich1974 still p | PASS | entry census | journal_manuscript_v22_dam_refs.tex |
| V21-1 | final-prose M1/M2: memory-subsection transcript token harmonized to +0 | PASS | tokens (comment-stripped body) | journal_manuscript_v22.tex Discussion (memory subsectio |
| V21-2 | final-prose M3: the six in-text figure references carry the Springer ' | PASS | Fig.~ sites: 6 | journal_manuscript_v22.tex |
| V21-3 | final-prose C1: the where-clause of the piecewise-holonomy formula res | PASS | where-index 46921 < affine-index 47022 | companion_categorical_v15.tex thm:stratified-holonomy |
| V21-4 | final-prose C2: the two-contractions remark's state space is the theor | PASS | state space | companion_categorical_v15.tex rem:two-contractions |
| V21-5 | final-prose C4: companion figure captions carry the journal's 'Fig. n' | PASS | Figure~ sites: 0; Fig.~ sites: 4 | companion_categorical_v15.tex preamble + text |
| V21-6 | final-prose C3: the Ito-expansion proof's variance parenthetical is an | PASS | punctuation | companion_categorical_v15.tex lem:ito-expand proof |
| V21-7 | v22 refs + v15 bib carried unchanged: the 29-entry list; companion_ref | PASS | entries 29; bib identical: True | journal_manuscript_v22_dam_refs.tex + companion_refs_v1 |
| V22-1 | main availability statement wired to the Zenodo archive: 'archived on  | PASS | tokens (raw source) | journal_manuscript_v22.tex Data, Software, and Code Ava |
| V22-2 | companion availability paragraph wired to the Zenodo archive: 'archive | PASS | tokens (raw source) | companion_categorical_v15.tex Declarations |
| V22-3 | v22 refs + v15 bib + v22 refs database carried: the 29-entry reference | PASS | entries 29; entries identical: True; bib identical: True | journal_manuscript_v22_dam_refs.tex + companion_refs_v1 |
| V22-4 | main minimal-diff: reversing the six declared V22 edits on journal_man | PASS | byte-identical after reverse: True | journal_manuscript_v22.tex vs journal_manuscript_v21.te |
| V22-5 | companion minimal-diff: reversing the five declared V15 edits on compa | PASS | byte-identical after reverse: True | companion_categorical_v15.tex vs companion_categorical_ |
| V22-6 | the two Reproducibility count sites refreshed to the v32 ledger: '($37 | PASS | count sites | journal_manuscript_v22.tex Reproducibility |
