...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b2926': (np.float64(0.701), np.float64(0.0)), 'b0755': (np.float64(0 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
