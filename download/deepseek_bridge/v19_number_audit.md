...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b3867': (np.float64(1.0), np.float64(0.0)), 'b3612': (np.float64(0.8 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
