...
| JP-3 | BMB retarget: abstract <= 300 words; no Author Summary; keywords line  | PASS | abstract 255w, keywords 6 | v3 front matter |
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b2779': (np.float64(0.81), np.float64(0.0)), 'b3612': (np.float64(0. | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
