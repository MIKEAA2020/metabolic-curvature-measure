# V20/V13 numeric consistency audit (Discover Applied Mathematics round: F2-F6 light touch-up + venue gates; v29 ledger retargeted to journal_manuscript_v20.tex + companion_categorical_v13.tex)

**359 PASS / 0 FAIL of 359 checks.**
...
| KEIO-11 | companion quotes fractions 0.498 and 0.853 (battery) | PASS | 0.498 count: 3, 0.853 count: 3 | companion_categorical_v13.tex:prop:poincare-averaging + |
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b3867': (np.float64(1.0), np.float64(0.0)), 'b1779': (np.float64(0.7 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
...
| O2-15 | prop:keio-o2-limited + rem:keio-o2-invariance in companion; abstract p | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v13.tex (abstract + Keio section) |
...
| N-17 | prop:keio-n-source + rem:keio-n-invariance in companion; abstract carr | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v13.tex (abstract + Keio section) |
...
| R8-ABS-five-axes | abstract: 'robust across six axes: carbon, oxygen, nitrogen, phosphate | PASS | True | companion_categorical_v13.tex abstract |
| R8-ABS-wordcount | abstract under the 250-word Discover Applied Mathematics cap | PASS | 248 words | companion_categorical_v13.tex abstract |
| R8-TEX-fourth-axis proposition | anchor prop:keio-phosphate present | PASS | True | companion_categorical_v13.tex |
| R8-TEX-four-axis remark | anchor rem:keio-p-invariance present | PASS | True | companion_categorical_v13.tex |
| R8-TEX-canonical-selection subsection | anchor sec:canonical-selection present | PASS | True | companion_categorical_v13.tex |
| R8-TEX-homogenized table | anchor tab:canonical-selection present | PASS | True | companion_categorical_v13.tex |
| R8-TEX-selection-rule remark | anchor rem:canonical-protocol present | PASS | True | companion_categorical_v13.tex |
...
| R9-TEX-anchors | prop:keio-iron + rem:keio-iron-invariance present, exactly once | PASS | prop x1, rem x1 | companion_categorical_v13.tex |
| R9-TEX-table-rows | iron x5 + arginine x2 rows present in tab:canonical-selection; restore | PASS | iron01 x1, iron005 x2, iron0025 x2, arg x2 | companion_categorical_v13.tex |
| R9-TEX-escapes | no double-escaped commands remain (patch-F rendering defect fixed: bio | PASS | \\emph x0, \\S\\ref x0 | companion_categorical_v13.tex |
...
| S-13 | patch H present: prop:keio-atpm, rem:keio-multiaxis, ATPM table rows,  | PASS | all present: True | companion_categorical_v13.tex |
| S-14 | six-axis abstract word count < 250 (DAM cap) | PASS | words: 248 | companion_categorical_v13.tex abstract |
...
| P-10 | engine bracket [+0.475,+0.943] and path-dependence wording present; 'c | PASS | bracket present: True | companion_categorical_v13.tex |
...
| P-14 | patch I present: five amendments, no regressions ('45--202', '1,129',  | PASS | edits present: True | companion_categorical_v13.tex |
...
| P-29 | patch J present: tie-break paragraph, closure clauses, feature count f | PASS | edits present: True | companion_categorical_v13.tex |
...
| V17-FM1 | abstract <= 249 audit-style words (DAM cap; v20 carries it at 245) wit | PASS | 245 words | journal_manuscript_v20.tex abstract |
| V17-FM2 | refs: 29 entries with kacser1973 + heinrich1974 added; both cited in t | PASS | 29 entries | journal_manuscript_v20_dam_refs.tex |
| V18-FM1 | CRediT authorship contribution statement (retained from the JTB round; | PASS | CRediT roles | journal_manuscript_v20.tex backmatter |
| V18-FM2 | keywords: 6 terms (BMB 4-6); 'path dependence' (the JTB-only 7th term) | PASS | 6 terms | journal_manuscript_v20.tex keywords |
| V19-FM3 | structural restructure: categorical subsection out, corollary retained | PASS | 5 sub-gates | journal_manuscript_v20.tex structure |
| V19-FM4 | plain title retained; v20 narrows it to the measured claim ('predicts  | PASS | title gates | journal_manuscript_v20.tex front matter |
| V19-FM5 | intro claim structure rebuilt: five-finding enumeration gone, three qu | PASS | intro gates | journal_manuscript_v20.tex intro (vs the v18 claim list |
| V20-1 | F3: direct trajectory rank correlation reported (rho = +0.92 P1 / +0.9 | PASS | artifact 0.9176 / 0.9551 (n 424) | v20_path_rank_stability.json + journal_manuscript_v20.t |
| V20-2 | F4: intro Glivenko--Cantelli sentence carries the two-regime qualifier | PASS | qualifier present: True | journal_manuscript_v20.tex intro |
| V20-3 | F5: 'rank identity' -> 'rank agreement'; 'metric invariance holds' ->  | PASS | old forms absent: True | journal_manuscript_v20.tex |
| V20-4 | F6: translation-buffering mechanism hedged at both remaining flat site | PASS | abstract hedge: True | journal_manuscript_v20.tex abstract + intro |
| V20-5 | DAM formatting: numeric square-bracket citations in both manuscripts;  | PASS | natbib/caption gates | journal_manuscript_v20.tex + companion_categorical_v13. |
| V20-6 | F2: companion six-axis sentence covers all three body categories -- th | PASS | qualifier present: True | companion_categorical_v13.tex abstract |
| V20-7 | companion keywords: 6 terms (Springer 4-6 range); 2-category / informa | PASS | 6 terms | companion_categorical_v13.tex keywords |
| V20-8 | cross-citation titles aligned: the main cites the companion's actual t | PASS | both aligned | journal_manuscript_v20_dam_refs.tex + companion_refs_v1 |
| V20-9 | Reproducibility text: the stated audit-suite size equals the v30 ledge | PASS | stated == $359$ | journal_manuscript_v20.tex Reproducibility + this audit |
| V20-10 | v20 refs list: 29 entries preserved (kacser1973 + heinrich1974 still p | PASS | entry census | journal_manuscript_v20_dam_refs.tex |
