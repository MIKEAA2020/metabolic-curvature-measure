# v12 numeric consistency audit (symmetric iJO second-engine + tie-break promotion round; v26 retarget of the v25 ledger to journal_manuscript_v18.tex + JTB gates)

**347 PASS / 0 FAIL of 347 checks.**
...
| JP-3 | JTB retarget: abstract <= 250 words (live JTB Guide for Authors); no A | PASS | abstract 249w, keywords 7 | v3 front matter |
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b1779': (np.float64(0.701), np.float64(0.0)), 'b2779': (np.float64(0 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
...
| V17-FM1 | abstract <= 250 audit-style words (JTB cap; v18 trims it to 249) with  | PASS | 249 words | journal_manuscript_v18.tex abstract |
| V17-FM2 | refs: 29 entries with kacser1973 + heinrich1974 added; both cited in t | PASS | 29 entries | journal_manuscript_v18_refs.tex |
| V18-FM1 | CRediT authorship contribution statement in the taxonomy form required | PASS | CRediT roles | journal_manuscript_v18.tex backmatter |
| V18-FM2 | keywords: 7 terms (JTB 1-7) with the new term 'path dependence' indexi | PASS | 7 terms | journal_manuscript_v18.tex keywords |
| V18-FM3 | highlights file (separate editable .docx, 'highlights' in the file nam | PASS | 5 bullets, lengths [66, 69, 72, 76, 76] | download/highlights_jtb.docx |
