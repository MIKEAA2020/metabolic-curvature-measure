# v12 numeric consistency audit (symmetric iJO second-engine + tie-break promotion round; v27 retarget of the v26 ledger to journal_manuscript_v19.tex + BMB gates + V19 restructure gates)

**349 PASS / 0 FAIL of 349 checks.**
...
| JP-3 | BMB retarget: abstract 150-250 words (Springer/BMB guideline, live-ver | PASS | abstract 243w, keywords 6 | v3 front matter |
...
| KEIO-11 | companion quotes fractions 0.498 and 0.853 (battery) | PASS | 0.498 count: 3, 0.853 count: 3 | companion_categorical_v12.tex:prop:poincare-averaging + |
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b0755': (np.float64(0.843), np.float64(0.0)), 'b3612': (np.float64(0 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
...
| O2-15 | prop:keio-o2-limited + rem:keio-o2-invariance in companion; abstract p | PASS | labels present: True / True; abstract words: 264 | companion_categorical_v12.tex (abstract + Keio section) |
...
| N-17 | prop:keio-n-source + rem:keio-n-invariance in companion; abstract carr | PASS | labels present: True / True; abstract words: 264 | companion_categorical_v12.tex (abstract + Keio section) |
...
| R8-ABS-five-axes | abstract: 'robust across six axes: carbon, oxygen, nitrogen, phosphate | PASS | True | companion_categorical_v12.tex abstract |
| R8-ABS-wordcount | abstract under the 265-word cap | PASS | 264 words | companion_categorical_v12.tex abstract |
| R8-TEX-fourth-axis proposition | anchor prop:keio-phosphate present | PASS | True | companion_categorical_v12.tex |
| R8-TEX-four-axis remark | anchor rem:keio-p-invariance present | PASS | True | companion_categorical_v12.tex |
| R8-TEX-canonical-selection subsection | anchor sec:canonical-selection present | PASS | True | companion_categorical_v12.tex |
| R8-TEX-homogenized table | anchor tab:canonical-selection present | PASS | True | companion_categorical_v12.tex |
| R8-TEX-selection-rule remark | anchor rem:canonical-protocol present | PASS | True | companion_categorical_v12.tex |
...
| R9-TEX-anchors | prop:keio-iron + rem:keio-iron-invariance present, exactly once | PASS | prop x1, rem x1 | companion_categorical_v12.tex |
| R9-TEX-table-rows | iron x5 + arginine x2 rows present in tab:canonical-selection; restore | PASS | iron01 x1, iron005 x2, iron0025 x2, arg x2 | companion_categorical_v12.tex |
| R9-TEX-escapes | no double-escaped commands remain (patch-F rendering defect fixed: bio | PASS | \\emph x0, \\S\\ref x0 | companion_categorical_v12.tex |
...
| S-13 | patch H present: prop:keio-atpm, rem:keio-multiaxis, ATPM table rows,  | PASS | all present: True | companion_categorical_v12.tex |
| S-14 | six-axis abstract word count < 265 | PASS | words: 264 | companion_categorical_v12.tex abstract |
...
| P-10 | engine bracket [+0.475,+0.943] and path-dependence wording present; 'c | PASS | bracket present: True | companion_categorical_v12.tex |
...
| P-14 | patch I present: five amendments, no regressions ('45--202', '1,129',  | PASS | edits present: True | companion_categorical_v12.tex |
...
| P-29 | patch J present: tie-break paragraph, closure clauses, feature count f | PASS | edits present: True | companion_categorical_v12.tex |
...
| V17-FM1 | abstract <= 250 audit-style words (BMB cap; v19 rebuilds it at 243) wi | PASS | 243 words | journal_manuscript_v19.tex abstract |
| V17-FM2 | refs: 29 entries with kacser1973 + heinrich1974 added; both cited in t | PASS | 29 entries | journal_manuscript_v19_bmb_refs.tex |
| V18-FM1 | CRediT authorship contribution statement (retained from the JTB round; | PASS | CRediT roles | journal_manuscript_v19.tex backmatter |
| V18-FM2 | keywords: 6 terms (BMB 4-6); 'path dependence' (the JTB-only 7th term) | PASS | 6 terms | journal_manuscript_v19.tex keywords |
| V19-FM3 | structural restructure: categorical subsection out, corollary retained | PASS | 5 sub-gates | journal_manuscript_v19.tex structure |
| V19-FM4 | new plain title replaces the two-clause 'Geometric Theory' title; old  | PASS | title gates | journal_manuscript_v19.tex front matter |
| V19-FM5 | intro claim structure rebuilt: five-finding enumeration gone, three qu | PASS | intro gates | journal_manuscript_v19.tex intro (vs the v18 claim list |
