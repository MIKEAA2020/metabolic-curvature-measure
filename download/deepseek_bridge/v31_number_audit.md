# V21/V14 numeric consistency audit (final-prose round: read-through findings + Fig.-label alignment; v30 ledger retargeted to journal_manuscript_v21.tex + companion_categorical_v14.tex)

**366 PASS / 0 FAIL of 366 checks.**
...
| KEIO-11 | companion quotes fractions 0.498 and 0.853 (battery) | PASS | 0.498 count: 3, 0.853 count: 3 | companion_categorical_v14.tex:prop:poincare-averaging + |
...
| O2-15 | prop:keio-o2-limited + rem:keio-o2-invariance in companion; abstract p | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v14.tex (abstract + Keio section) |
...
| N-17 | prop:keio-n-source + rem:keio-n-invariance in companion; abstract carr | PASS | labels present: True / True; abstract words: 248 | companion_categorical_v14.tex (abstract + Keio section) |
...
| R8-ABS-five-axes | abstract: 'robust across six axes: carbon, oxygen, nitrogen, phosphate | PASS | True | companion_categorical_v14.tex abstract |
| R8-ABS-wordcount | abstract under the 250-word Discover Applied Mathematics cap | PASS | 248 words | companion_categorical_v14.tex abstract |
| R8-TEX-fourth-axis proposition | anchor prop:keio-phosphate present | PASS | True | companion_categorical_v14.tex |
| R8-TEX-four-axis remark | anchor rem:keio-p-invariance present | PASS | True | companion_categorical_v14.tex |
| R8-TEX-canonical-selection subsection | anchor sec:canonical-selection present | PASS | True | companion_categorical_v14.tex |
| R8-TEX-homogenized table | anchor tab:canonical-selection present | PASS | True | companion_categorical_v14.tex |
| R8-TEX-selection-rule remark | anchor rem:canonical-protocol present | PASS | True | companion_categorical_v14.tex |
...
| R9-TEX-anchors | prop:keio-iron + rem:keio-iron-invariance present, exactly once | PASS | prop x1, rem x1 | companion_categorical_v14.tex |
| R9-TEX-table-rows | iron x5 + arginine x2 rows present in tab:canonical-selection; restore | PASS | iron01 x1, iron005 x2, iron0025 x2, arg x2 | companion_categorical_v14.tex |
| R9-TEX-escapes | no double-escaped commands remain (patch-F rendering defect fixed: bio | PASS | \\emph x0, \\S\\ref x0 | companion_categorical_v14.tex |
...
| S-13 | patch H present: prop:keio-atpm, rem:keio-multiaxis, ATPM table rows,  | PASS | all present: True | companion_categorical_v14.tex |
| S-14 | six-axis abstract word count < 250 (DAM cap) | PASS | words: 248 | companion_categorical_v14.tex abstract |
...
| P-10 | engine bracket [+0.475,+0.943] and path-dependence wording present; 'c | PASS | bracket present: True | companion_categorical_v14.tex |
...
| P-14 | patch I present: five amendments, no regressions ('45--202', '1,129',  | PASS | edits present: True | companion_categorical_v14.tex |
...
| P-29 | patch J present: tie-break paragraph, closure clauses, feature count f | PASS | edits present: True | companion_categorical_v14.tex |
...
| V17-FM1 | abstract <= 249 audit-style words (DAM cap; v20 carries it at 245) wit | PASS | 245 words | journal_manuscript_v21.tex abstract |
| V17-FM2 | refs: 29 entries with kacser1973 + heinrich1974 added; both cited in t | PASS | 29 entries | journal_manuscript_v21_dam_refs.tex |
| V18-FM1 | CRediT authorship contribution statement (retained from the JTB round; | PASS | CRediT roles | journal_manuscript_v21.tex backmatter |
| V18-FM2 | keywords: 6 terms (BMB 4-6); 'path dependence' (the JTB-only 7th term) | PASS | 6 terms | journal_manuscript_v21.tex keywords |
| V19-FM3 | structural restructure: categorical subsection out, corollary retained | PASS | 5 sub-gates | journal_manuscript_v21.tex structure |
| V19-FM4 | plain title retained; v20 narrows it to the measured claim ('predicts  | PASS | title gates | journal_manuscript_v21.tex front matter |
| V19-FM5 | intro claim structure rebuilt: five-finding enumeration gone, three qu | PASS | intro gates | journal_manuscript_v21.tex intro (vs the v18 claim list |
| V20-1 | F3: direct trajectory rank correlation reported (rho = +0.92 P1 / +0.9 | PASS | artifact 0.9176 / 0.9551 (n 424) | v20_path_rank_stability.json + journal_manuscript_v21.t |
| V20-2 | F4: intro Glivenko--Cantelli sentence carries the two-regime qualifier | PASS | qualifier present: True | journal_manuscript_v21.tex intro |
| V20-3 | F5: 'rank identity' -> 'rank agreement'; 'metric invariance holds' ->  | PASS | old forms absent: True | journal_manuscript_v21.tex |
| V20-4 | F6: translation-buffering mechanism hedged at both remaining flat site | PASS | abstract hedge: True | journal_manuscript_v21.tex abstract + intro |
| V20-5 | DAM formatting: numeric square-bracket citations in both manuscripts;  | PASS | natbib/caption gates | journal_manuscript_v21.tex + companion_categorical_v14. |
| V20-6 | F2: companion six-axis sentence covers all three body categories -- th | PASS | qualifier present: True | companion_categorical_v14.tex abstract |
| V20-7 | companion keywords: 6 terms (Springer 4-6 range); 2-category / informa | PASS | 6 terms | companion_categorical_v14.tex keywords |
| V20-8 | cross-citation titles aligned: the main cites the companion's actual t | PASS | both aligned | journal_manuscript_v21_dam_refs.tex + companion_refs_v1 |
| V20-9 | Reproducibility text: the stated audit-suite size equals the v31 ledge | PASS | stated == $366$ | journal_manuscript_v21.tex Reproducibility + this audit |
| V20-10 | v20 refs list: 29 entries preserved (kacser1973 + heinrich1974 still p | PASS | entry census | journal_manuscript_v21_dam_refs.tex |
| V21-1 | final-prose M1/M2: memory-subsection transcript token harmonized to +0 | PASS | tokens (comment-stripped body) | journal_manuscript_v21.tex Discussion (memory subsectio |
| V21-2 | final-prose M3: the six in-text figure references carry the Springer ' | PASS | Fig.~ sites: 6 | journal_manuscript_v21.tex |
| V21-3 | final-prose C1: the where-clause of the piecewise-holonomy formula res | PASS | where-index 46291 < affine-index 46392 | companion_categorical_v14.tex thm:stratified-holonomy |
| V21-4 | final-prose C2: the two-contractions remark's state space is the theor | PASS | state space | companion_categorical_v14.tex rem:two-contractions |
| V21-5 | final-prose C4: companion figure captions carry the journal's 'Fig. n' | PASS | Figure~ sites: 0; Fig.~ sites: 4 | companion_categorical_v14.tex preamble + text |
| V21-6 | final-prose C3: the Ito-expansion proof's variance parenthetical is an | PASS | punctuation | companion_categorical_v14.tex lem:ito-expand proof |
| V21-7 | v21 refs + v14 bib carried unchanged: the 29-entry list; companion_ref | PASS | entries 29; bib identical: True | journal_manuscript_v21_dam_refs.tex + companion_refs_v1 |
