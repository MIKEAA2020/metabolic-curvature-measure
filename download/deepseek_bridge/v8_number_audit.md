...
| R8-TAB-rows | 18 canonical rows (10 iJO + 8 iML... = 10 + 7 + iML-N 2) -> 17 with ar | PASS | 17 artifact levels; table rows: 10 iJO + 7 iML | tab:canonical-selection |
| R8-ABS-four-axes | abstract: 'medium-robust across four axes: carbon-source, oxygen, nitr | PASS | True | companion_categorical_v3.tex abstract |
