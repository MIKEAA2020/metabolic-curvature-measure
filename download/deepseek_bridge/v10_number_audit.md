# v10 numeric consistency audit (fifth-axis iron + arginine round)

**271 PASS / 0 FAIL of 271 checks.**
...
| O2-13 | flip ratios (CORRECTED): glycolysis six 0.70-1.00 aerobically -> 0 ana | PASS | {'b3612': (np.float64(0.843), np.float64(0.0)), 'b2779': (np.float64(0 | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
