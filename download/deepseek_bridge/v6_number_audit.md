...
| O2-13 | flip ratios: glycolysis six 0.70-1.00 aerobically -> 0 anaerobically;  | PASS | {'b2779': (np.float64(0.81), np.float64(0.0)), 'b1779': (np.float64(0. | keio_o2_limited_e16_sweep.csv + keio_glucose_only_e16_s |
...
| O2-15 | prop:keio-o2-limited + rem:keio-o2-invariance in companion; abstract p | PASS | labels present: True / True; abstract words: 262 | companion_categorical_v3.tex (abstract + Keio section) |
