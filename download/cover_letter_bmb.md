...
- The **submitted manuscript** is the application: the
  ...
  that motivated the active-set curvature interpretation (its §2.5),
...
`scripts/companion_categorical_v8.tex`, compiled PDF included) and will
...
artifacts, verified by a 301-check numeric audit (301/301 PASS) that
