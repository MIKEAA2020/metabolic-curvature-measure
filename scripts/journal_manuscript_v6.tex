...
%  standalone theory companion (scripts/companion_categorical_v5.tex),
...
complex, and that this measure is the canonical carrier of the
network's rerouting geometry: loop holonomy
...
\input{journal_manuscript_v6_bmb_refs}
