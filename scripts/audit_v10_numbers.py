...
out = {"experiment": "v10 numeric consistency audit (six-axis round: "
       ...
       "counts_ledger": [{"value": v, "meaning": m, "source": s}
                         for v, m, s in ledger],
       "checks": checks}
with open(os.path.join(DB, "v10_number_audit.json"), "w") as f:
    json.dump(out, f, indent=1, default=str)

md = ["# v10 numeric consistency audit (fifth-axis iron + arginine round)", "",
...
with open(os.path.join(DB, "v10_number_audit.md"), "w") as f:
    f.write("\n".join(md))
