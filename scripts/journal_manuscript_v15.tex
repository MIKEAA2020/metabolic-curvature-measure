...
%  journal_manuscript_v15_bmb_refs.tex. Long technical proofs are
...
$0.89$ --- more than double; MWU $1.3 \times 10^{-7}$). The baseline reproduces to the
...
\input{journal_manuscript_v15_bmb_refs}
