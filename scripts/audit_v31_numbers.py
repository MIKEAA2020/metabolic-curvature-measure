#!/usr/bin/env python3
"""
Numeric consistency audit of journal_manuscript_v21.tex +
companion_categorical_v14.tex (V21/V14 final-prose round: the
...
unchanged; extends the v28 audit of)companion_categorical_v14.tex (V11 companion-alignment round: the
...
journal_manuscript_v21_dam_refs.tex; every v18 number unchanged,
...
companion_categorical_v14.tex (universal Gemini-adoption round:
...
check("JP-2", "DAM retarget: numeric square-bracket citations "
      ...
      "journal_manuscript_v21_dam_refs" in tex2 and
...
companion = open(os.path.join(BASE, "scripts", "companion_categorical_v14.tex"),
                 encoding="utf-8").read()
check("KEIO-11", "companion quotes fractions 0.498 and 0.853 (battery)",
      "companion_categorical_v14.tex:prop:poincare-averaging + tab:network-battery",
...
check("O2-15", "prop:keio-o2-limited + rem:keio-o2-invariance in companion; "
      ...
      "companion_categorical_v14.tex (abstract + Keio section)",
...
check("R8-ABS-five-axes",
      ...
      "companion_categorical_v14.tex abstract",
...
check("R8-ABS-wordcount",
      ...
      "companion_categorical_v14.tex abstract", f"{nwords} words",
      nwords < 250)
...
check("V17-FM1", "abstract <= 249 audit-style words (DAM cap; "
      ...
      "journal_manuscript_v21.tex abstract", f"{nwords17} words",
...
check("V17-FM2", "refs: 29 entries with kacser1973 + heinrich1974 "
      ...
      "journal_manuscript_v21_dam_refs.tex", f"{n17} entries",
...
check("V18-FM1", "CRediT authorship contribution statement "
      ...
      "author, roles listed)",
      "journal_manuscript_v21.tex backmatter", "CRediT roles",
      credit_ok)
...
check("V18-FM2", "keywords: 6 terms (BMB 4-6); 'path dependence' "
      ...
      "journal_manuscript_v21.tex keywords", f"{kw_terms18} terms",
      kw_terms18 == 6 and
...
check("V19-FM3", "structural restructure: categorical subsection out, "
      ...
      "journal_manuscript_v21.tex structure", "5 sub-gates",
...
check("V19-FM4", "plain title retained; v20 narrows it to the measured "
      ...
      "journal_manuscript_v21.tex front matter", "title gates",
...
check("V19-FM5", "intro claim structure rebuilt: five-finding "
      ...
      "journal_manuscript_v21.tex intro (vs the v18 claim list)",
      "intro gates",
...
check("V20-1", "F3: direct trajectory rank correlation reported "
      ...
      "v20_path_rank_stability.json + journal_manuscript_v21.tex",
      "artifact %.4f / %.4f (n %d)" % (
...
check("V20-2", "F4: intro Glivenko--Cantelli sentence carries the "
      ...
      "journal_manuscript_v21.tex intro",
...
check("V20-4", "F6: translation-buffering mechanism hedged at both "
      ...
      "journal_manuscript_v21.tex abstract + intro",
...
check("V20-5", "DAM formatting: numeric square-bracket citations in "
      ...
      "journal_manuscript_v21.tex + companion_categorical_v14.tex",
...
check("V20-7", "companion keywords: 6 terms (Springer 4-6 range); "
      ...
      "companion_categorical_v14.tex keywords", f"{_kw13_terms} terms",
...
_expected_total = len(checks) + 2 + 7  # V20-9 (self) + V20-10 (refs) + V21-1..V21-7
check("V20-9", "Reproducibility text: the stated audit-suite size "
      "equals the v31 ledger size (no stale check count)",
      "journal_manuscript_v21.tex Reproducibility + this audit",
...
check("V20-10", "v20 refs list: 29 entries preserved (kacser1973 + "
      ...
      "changed)",
      "journal_manuscript_v21_dam_refs.tex", "entry census",
...
md = ["# V21/V14 numeric consistency audit (final-prose round: read-through findings + Fig.-label alignment; v30 ledger retargeted to journal_manuscript_v21.tex + companion_categorical_v14.tex)", "",
