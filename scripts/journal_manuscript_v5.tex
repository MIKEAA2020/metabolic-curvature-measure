...
%  standalone theory companion (scripts/companion_categorical_v4.tex),
...
nonzero genes); (b) metric comparison: the precursor time-course
...
analysis code, performed the data analysis, and drafted and revised
the manuscript.

\input{journal_manuscript_v5_bmb_refs}
