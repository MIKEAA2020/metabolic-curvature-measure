#!/bin/bash
# Build self-contained, compile-ready submission ZIPs for the v5 round:
# main = journal_manuscript_v4.tex (BMB), companion = companion_categorical_v3.tex (TAC).
# Changes vs build_submission_zips_v4.sh (v4 round):
#   - companion v3 patch F (six-axis round: phosphate/iron/ATPM props,
#     canonical-selection protocol subsection, six-axis abstract)
# Each ZIP verified by fresh-dir tectonic compile.
set -euo pipefail
cd /home/z/my-project/metabolic-curvature-measure

STAGE=scripts/overleaf_stage_v5
rm -rf "$STAGE"
...
rm -rf /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5 && mkdir -p /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/main /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/companion
unzip -q download/submission_main_bmb.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/main
unzip -q download/submission_companion_tac.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/companion
echo "=== fresh-dir compile: main v4 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/main && tectonic journal_manuscript_v4.tex 2>&1 | tail -2 && \
 pdfinfo journal_manuscript_v4.pdf | grep Pages)
echo "=== fresh-dir compile: companion v3 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v5/companion && tectonic companion_categorical_v3.tex 2>&1 | tail -2 && \
