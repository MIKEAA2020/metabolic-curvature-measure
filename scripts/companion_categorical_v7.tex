% =====================================================================
%  companion_categorical_v7.tex -- standalone theory paper.
%  ---------------------------------------------------------------
...
%  Relation:   the application paper (journal_manuscript_v8.tex)
...
constraints. We develop the categorical and
homotopy-theoretic framework for viability-weighted curvature: the
geometric object measuring how non-commuting manageable changes
accumulate into a viability threat through the policy holonomy.
(i)~The SAVGS object assembles a control base, a Fisher--Rao
policy bundle, a viability margin, a maintenance graph, and a
$2$-categorical boundary span into a stratified bundle.
...
seven-map instantiation; the projected CPTP contraction
...
signature of non-commutativity. Classical viability theory supplies
...
changes---this requirement fails in three ways at once: the
horizontal subspaces vary discontinuously, the connection
coefficients (the local sensitivity gains of the active constraints)
jump, and the curvature integral, which presupposes a smooth
connection, is no longer defined. The holonomy of a loop that
crosses such a boundary is therefore defined only after the
boundary behavior itself is specified. The fifth SAVGS component
...
\bibliography{companion_refs_v7}
