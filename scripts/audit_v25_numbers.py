#!/usr/bin/env python3
"""
Numeric consistency audit of journal_manuscript_v17.tex +
...
tex2 = open(os.path.join(BASE, "scripts",
                         "journal_manuscript_v17.tex")).read()
import math
...
out = {"experiment": "v12 numeric consistency audit (symmetric iJO "
       ...
       "counts_ledger": [{"value": v, "meaning": m, "source": s}
                         for v, m, s in ledger],
       "checks": checks}
with open(os.path.join(DB, "v25_number_audit.json"), "w") as f:
...
with open(os.path.join(DB, "v25_number_audit.md"), "w") as f:
    f.write("\n".join(md))
