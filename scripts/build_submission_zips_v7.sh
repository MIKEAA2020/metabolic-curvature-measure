#!/bin/bash
# Build self-contained, compile-ready submission ZIPs for the v7 round:
# main = journal_manuscript_v4.tex (BMB), companion = companion_categorical_v3.tex (TAC).
# Changes vs build_submission_zips_v6.sh (v6 round):
#   - Author identity finalized in both manuscripts: Amin Abaee, Independent
#     Researcher, Tehran, Iran; amin_abaee@ut.ac.ir; ORCID 0000-0002-0019-1842
#     (title block, \thanks footnote, Author Contributions, pdfauthor).
#   - Main (BMB guideline compliance): abstract trimmed to 245 words
#     (Springer BMB limit 150-250); continuous line numbering enabled
#     (\usepackage{lineno} + \linenumbers); keywords re-selected for
...
#   - Companion (TAC): visible Keywords line (optic category; stratified
#     connection; 2-category; filtered colimit; homotopy type theory;
#     applied category theory) + AMS 2020 Subject Classification
#     (18D05; 18N99; 92B05) per TAC indexing requirements.
#   - Audits after the edits: main audit_v4 98/98 PASS; companion
#     audit_v12 301/301 PASS.
# Each ZIP verified by fresh-dir tectonic compile.
set -euo pipefail
cd /home/z/my-project/metabolic-curvature-measure

STAGE=scripts/overleaf_stage_v7
rm -rf "$STAGE"
...
rm -rf /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7 && mkdir -p /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/main /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/companion
unzip -q download/submission_main_bmb.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/main
unzip -q download/submission_companion_tac.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/companion
echo "=== fresh-dir compile: main v4 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/main && tectonic journal_manuscript_v4.tex 2>&1 | tail -2 && \
 pdfinfo journal_manuscript_v4.pdf | grep Pages)
echo "=== fresh-dir compile: companion v3 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v7/companion && tectonic companion_categorical_v3.tex 2>&1 | tail -2 && \
