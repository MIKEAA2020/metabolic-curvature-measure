...
unchanged; extends the v28 audit of)companion_categorical_v13.tex (V11 companion-alignment round: the
...
journal_manuscript_v20_dam_refs.tex; every v18 number unchanged,
...
companion_categorical_v13.tex (universal Gemini-adoption round:
...
tex2 = open(os.path.join(BASE, "scripts",
                         "journal_manuscript_v20.tex")).read()
import math
...
check("JP-2", "DAM retarget: numeric square-bracket citations "
      ...
      "journal_manuscript_v20_dam_refs" in tex2 and
...
companion = open(os.path.join(BASE, "scripts", "companion_categorical_v13.tex"),
                 encoding="utf-8").read()
check("KEIO-11", "companion quotes fractions 0.498 and 0.853 (battery)",
      "companion_categorical_v13.tex:prop:poincare-averaging + tab:network-battery",
...
check("O2-15", "prop:keio-o2-limited + rem:keio-o2-invariance in companion; "
      ...
      "companion_categorical_v13.tex (abstract + Keio section)",
...
tex = open(os.path.join(BASE, "scripts",
                        "companion_categorical_v13.tex")).read()
...
check("R8-ABS-wordcount",
      ...
      "companion_categorical_v13.tex abstract", f"{nwords} words",
      nwords < 250)
...
check("V17-FM1", "abstract <= 249 audit-style words (DAM cap; "
      ...
      "journal_manuscript_v20.tex abstract", f"{nwords17} words",
...
check("V17-FM2", "refs: 29 entries with kacser1973 + heinrich1974 "
      ...
      "journal_manuscript_v20_dam_refs.tex", f"{n17} entries",
...
check("V18-FM1", "CRediT authorship contribution statement "
      ...
      "author, roles listed)",
      "journal_manuscript_v20.tex backmatter", "CRediT roles",
      credit_ok)
...
check("V18-FM2", "keywords: 6 terms (BMB 4-6); 'path dependence' "
      ...
      "journal_manuscript_v20.tex keywords", f"{kw_terms18} terms",
      kw_terms18 == 6 and
...
check("V19-FM3", "structural restructure: categorical subsection out, "
      ...
      "journal_manuscript_v20.tex structure", "5 sub-gates",
...
check("V19-FM5", "intro claim structure rebuilt: five-finding "
      ...
      "journal_manuscript_v20.tex intro (vs the v18 claim list)",
      "intro gates",
...
md = ["# V20/V13 numeric consistency audit (Discover Applied Mathematics round: F2-F6 light touch-up + venue gates; v29 ledger retargeted to journal_manuscript_v20.tex + companion_categorical_v13.tex)", "",
