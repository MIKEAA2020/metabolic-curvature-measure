...
$\Sigma$ is the small enclosed disk. For affine wall transitions
...
range. Fig.~\ref{fig:lip-per-optic} shows the bar chart of analytic
...
places (Fig.~\ref{fig:cptc-zeno}; deposited verification
artifacts).
\end{proof}
...
structurally (as the caption of Fig.~\ref{fig:hasse-extended}
...
\href{https://doi.org/10.5281/zenodo.22940820}{DOI 10.5281/zenodo.
