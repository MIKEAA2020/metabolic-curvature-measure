...
#   - All numerical claims re-verified: audit_v24_numbers.py 301/301
#     PASS; pattern_sweep_v16 16/16 clean; verify_v16_completeness.py +
...
STAGE=scripts/overleaf_stage_v19
rm -rf "$STAGE"
mkdir -p "$STAGE/main" "$STAGE/companion"

# ---------- MAIN (Bulletin of Mathematical Biology) ----------
M=$STAGE/main
cp scripts/journal_manuscript_v16.tex          "$M/"
cp scripts/journal_manuscript_v16_bmb_refs.tex "$M/"
cp scripts/journal_manuscript_v16_refs.bib     "$M/"
...
- Overleaf: upload this ZIP via New Project -> Upload Project, set the main
  document to journal_manuscript_v16.tex, recompile. (Run twice so natbib
  citations resolve; Overleaf does this automatically.)
- Command line: pdflatex journal_manuscript_v16.tex  (x2)

## Contents
- journal_manuscript_v16.tex        main source (main document)
- journal_manuscript_v16_bmb_refs.tex  reference list (input by the main file)
- journal_manuscript_v16_refs.bib   underlying BibTeX database (not required
...
- Abstract: 255 words (within the author's 255-word cap), in two paragraphs
  (theory; biology).
...
rm -rf /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19 && mkdir -p /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/main /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/companion
unzip -q download/submission_main_bmb.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/main
unzip -q download/submission_companion_tac.zip -d /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/companion
echo "=== fresh-dir compile: main v16 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/main && tectonic journal_manuscript_v16.tex 2>&1 | tail -2 && \
 pdfinfo journal_manuscript_v16.pdf | grep Pages)
echo "=== fresh-dir compile: companion v10 ==="
(cd /home/z/my-project/metabolic-curvature-measure/scripts/zipcheck_v19/companion && tectonic companion_categorical_v10.tex 2>&1 | tail -2 && \
