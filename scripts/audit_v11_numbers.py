...
out = {"experiment": "v11 numeric consistency audit (proof-read + "
       ...
       "counts_ledger": [{"value": v, "meaning": m, "source": s}
                         for v, m, s in ledger],
       "checks": checks}
with open(os.path.join(DB, "v11_number_audit.json"), "w") as f:
    json.dump(out, f, indent=1, default=str)

md = ["# v11 numeric consistency audit (proof-read + second-engine round)", "",
...
with open(os.path.join(DB, "v11_number_audit.md"), "w") as f:
    f.write("\n".join(md))
